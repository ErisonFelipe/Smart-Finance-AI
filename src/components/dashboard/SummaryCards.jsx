...
export default function SummaryCards({ saldoAtual, receitasMes, despesasMes, investimentosMes }) {
  const valores = [saldoAtual, receitasMes, despesasMes, investimentosMes];
